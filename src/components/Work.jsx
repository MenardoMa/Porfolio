    ...
    <section id='projets'>
        <div className='container'>
            ...
            <Button
                ...
                path="#"
                className='bg-[#f5f4f2] cursor-pointer mx-auto mt-8 md:mt-10 text-black text-sm font-rubik border border-zinc-200 px-4 py-3 font-normal rounded-full flex items-center justify-center hover:bg-zinc-200/50 active:bg-zinc-200/50 ring-1 ring-inset ring-zinc-50/5 w-max reveal-up'
            />
        </div>
    </section>
  )
