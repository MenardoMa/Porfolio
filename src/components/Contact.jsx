    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch mt-10">
        ...
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input
                ...
                className="font-rubik text-field up-reveal"
              />
            </div>
            <div className="mb-4">
              <label htmlFor="email" className="font-rubik font-normal label up-reveal">
                Email
              </label>
              <input
                type="email"
          ...
          <div className="">
            <label htmlFor="message" className="font-rubik font-normal label up-reveal">
              Message
            </label>
            <textarea
              name="message"
              ...
              placeholder="salut ."
              required
              className="font-rubik text-field resize-y min-h-20 max-h-50 up-reveal"
            ></textarea>
          </div>
          <Button
            label="Envoyer"
            className="btn send cursor-pointer mt-4 font-rubik border border-zinc-200 up-reveal"
          />
        </form>
      </div>
    </section>
